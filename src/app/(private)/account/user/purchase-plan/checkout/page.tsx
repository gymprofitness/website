    ...
    return (
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8 p-8 text-center bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">No Plan Selected</h2>
          <p className="text-gray-600 mb-6">
            You haven't selected a plan yet. Please go back to the plans page and choose a plan.
          </p>
          <Button asChild>
      ...
      <div className="mt-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            ...
            <p className="text-sm text-gray-500">Review your subscription details</p>
          </div>
          ...
          <div className="p-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="font-medium text-gray-900">{selectedPaymentPlan.mainPlan?.name}</h3>
                <p className="text-sm text-gray-500">{selectedPaymentPlan.paymentPlan?.planName} Plan</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <span className="font-medium text-gray-900">₹{selectedPaymentPlan.paymentPlan?.price}</span>
              </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <span className="font-medium text-gray-900">{selectedPaymentPlan.paymentPlan?.duration} days</span>
              </div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xl font-bold text-gray-900">₹{selectedPaymentPlan.paymentPlan?.price}</span>
              </div>
